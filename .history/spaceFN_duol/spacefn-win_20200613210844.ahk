...
*u::dual.comboKey({F22: "Up"})
*n::dual.comboKey({F22: "Left"})
*e::dual.comboKey({F22: "Down"})
*i::dual.comboKey({F22: "Right"})

*l::dual.comboKey({F22: "Home"})
*y::dual.comboKey({F22: "End"})

*t::dual.comboKey({F22: "Ctrl"})
*t::dual.comboKey({F22: "Shift"})
*t::dual.comboKey({F22: "Alt"})
