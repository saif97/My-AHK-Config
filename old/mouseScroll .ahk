...
; === SETTINGS ===
k := 0.05						; scroll speed coefficient (higher k = more speed)
...
panp := getkeystate("Shift", "P")					; save key state / set the key used to scroll
tikp := A_TickCount									; save time
loop 
{
	sleep 30
	pan := getkeystate("Shift", "P")				; set the key used to scroll
